...
const handleScroll = (e) => {
  ...
  if (dashboardMicroexperienceLoading && (!dashboardMicroexperience || dashboardMicroexperience.length === 0)) {
    return (
    ...
    >
      <div className="grid gap-4 p-4">
        {dashboardMicroexperience && dashboardMicroexperience.length > 0 ? (
          ...
          <p className="text-center text-gray-500">No micro experiences found</p>
        )}
