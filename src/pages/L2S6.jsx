...
const L2S6 = () => {
  ...
  return (
    <div className="bg-[#1A104F]">
      <div className="min-h-screen  text-white p-5 flex flex-col relative overflow-hidden max-w-[375px] mx-auto">
        {/* Header */}
        <div className="mb-4">
          <img
            src="/assets/logo.svg"
          ...
          <>
            ...
            >
              ...
              <p className="text-sm text-gray-800 font-medium">
                ...
                discovered what matters most to children and families.
                Biomedical Engineers know that understanding user dreams creates
