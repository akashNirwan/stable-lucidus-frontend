...
const ErrorComponent = ({ containerClassName, imageClassName }) => {
  ...
  return (
    <div
      className={`${containerClassName} text-white dark:text-white px-2 w-full min-h-screen flex flex-col justify-center items-center text-center gap-4`}
    >
      <img
        className={`${imageClassName} w-96`}
        src={"/assets/forgot/404.svg"}
        alt="404-image"
      />
      {!error?.message ? (
