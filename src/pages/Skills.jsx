...
import { fetchSkills, updateSkills } from "../redux/actions/student-onboarding-action";
import { useDispatch, useSelector } from "react-redux";
import LoadingSpinner from "../components/common/LoadingSpinner";
import { useNavigate } from "react-router-dom";
const Skills = ({ setStep, stepsData }) => {
  const dispatch = useDispatch();
  const { skills, loading, skillsLoading } = useSelector((state) => state.student);
        ...
        {Array.isArray(skills) &&
          skills.map((skill) => (
            <TwoLineOption
              ...
              selected={selectedSkills.includes(skill._id)} // Boolean check
