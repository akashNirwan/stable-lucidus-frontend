    ...
    <div className="h-[100dvh] relative overflow-hidden">
      <div className="bg-[url(/on-boarding.svg)] h-full w-full bg-cover bg-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-start h-screen px-4 pt-12">
          <img src="/Astronaut4.svg" alt="Astronaut" />
        </div>
        ...
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 w-full md:max-w-[420px] md:mx-auto flex flex-col gap-5 p-6 h-[62vh] lg:h-[70vh] z-20 "
          style={{
